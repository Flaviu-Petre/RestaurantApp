        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DishId = table.Column<int>(type: "int", nullable: false),
                    QuantityInMenu = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderDetail_EitherDishOrMenu", "(DishId IS NULL AND MenuId IS NOT NULL) OR (DishId IS NOT NULL AND MenuId IS NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Found in wheat, barley, and rye", "Gluten" },
                    { 2, "Found in many baked goods", "Eggs" },
                    { 3, "Lactose and dairy products", "Milk" },
                    { 4, "Tree nuts like almonds, walnuts, etc.", "Nuts" },
                    { 5, "Legume used in many dishes", "Peanuts" },
                    { 6, "Various fish species", "Fish" },
                    { 7, "Crustaceans like shrimp, crab, lobster", "Shellfish" },
                    { 8, "Soybean products", "Soy" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Starters and small dishes", "Appetizers" },
                    { 3, "Hot and cold soups", "Soups" },
                    { 4, "Main dishes", "Main Courses" },
                    { 5, "Sweet dishes", "Desserts" },
                    { 6, "Drinks", "Beverages" }
                });
